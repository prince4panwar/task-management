...
function Profile() {
  ...
  return (
    <div
      className={`flex flex-col justify-start items-center h-screen sm:w-[80%] w-full sm:pt-2 mt-1 bg-blue-100 ${
    ...
    >
      <motion.div
        initial={{ y: 100 }}
        animate={{ y: 0 }}
        className={`sm:w-2/4 w-full sm:mt-4 p-4 sm:rounded-2xl shadow-[0px_0px_100px_10px_rgba(0,0,0,0.25)] ${
